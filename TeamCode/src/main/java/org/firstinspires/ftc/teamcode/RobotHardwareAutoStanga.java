...
public final class RobotHardwareAutoStanga
{
	public final MecanumDriveAutoStanga drivetrain;
	...
	public RobotHardwareAutoStanga(HardwareMap hardwareMap)
	{
		drivetrain = new MecanumDriveAutoStanga(hardwareMap, new Pose2d(0, 0, 0));
