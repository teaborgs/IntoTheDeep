...
public final class RobotHardwareAutoDreapta
{
	public final MecanumDriveAutoDreapta drivetrain;
	...
	public RobotHardwareAutoDreapta(HardwareMap hardwareMap)
	{
		drivetrain = new MecanumDriveAutoDreapta(hardwareMap, new Pose2d(0, 0, 0));
